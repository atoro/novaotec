...
<head>
  ...
  <title>Detalle Cursos Nova Otec</title>
  ...
  <div class="contenedor_principal">
    ...
    <section class="contenido">
      <div class="cursos">
        <div class="curso">
          <div class="img_curso">
            <img src="imagenes/cursos/detalle/1.jpg">
          </div>
          <h2>Lorem Ipsum</h2>
          <p>simply is dummy</p>
          <a href="detallecursodetalle.php">ver más</a>
        </div>
        <div class="curso">
          <div class="img_curso">
            <img src="imagenes/cursos/detalle/2.jpg">
          </div>
          <h2>Lorem Ipsum</h2>
          <p>simply is dummy</p>
          <a href="detallecursodetalle.php">ver más</a>
        ...
        <div class="curso">
          <div class="img_curso">
            <img src="imagenes/cursos/detalle/3.jpg">
          </div>
          <h2>Lorem Ipsum</h2>
          <p>simply is dummy</p>
          <a href="detallecursodetalle.php">ver más</a>
        ...
        <div class="curso">
          <div class="img_curso">
            <img src="imagenes/cursos/detalle/4.jpg">
          </div>
          <h2>Lorem Ipsum</h2>
          <p>simply is dummy</p>
          <a href="detallecursodetalle.php">ver más</a>
        ...
        <div class="curso">
          <div class="img_curso">
            <img src="imagenes/cursos/detalle/5.jpg">
          </div>
          <h2>Lorem Ipsum</h2>
          <p>simply is dummy</p>
          <a href="detallecursodetalle.php">ver más</a>
        ...
        <div class="curso">
          <div class="img_curso">
            <img src="imagenes/cursos/detalle/6.jpg">
          </div>
          <h2>Lorem Ipsum</h2>
          <p>simply is dummy</p>
          <a href="detallecursodetalle.php">ver más</a>
