...
if ($_POST["Modificar"]){
	$insertar = "UPDATE noticias SET titulo_noticia ='".$_POST["titulo_noticia"]."',contenido_noticia ='".$_POST["contenido_noticia"]."',completo_noticia ='".$_POST["completo_noticia"]."'   WHERE id  = '" .$_GET["id"]."' " ; 
        ...
        <table width="100%" border="1" align="center" cellpadding="0" cellspacing="0">
          ...
          <tr>
            ...
            <td valign="top" class="Letras1"><span class="textobox">
              <textarea name="contenido_noticia" cols="40" rows="5" class="Letras1" id="contenido_pcurso"><?php echo $rs["contenido_noticia"]; ?></textarea>
            </span></td>
          </tr>
          <tr>
